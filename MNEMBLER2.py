...
#                         (type,					,decompose, 		opcode,	augmentcode, second_word)
SEL810_OPCODES = {	"LAA":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o01,	0,		False),
					"LBA":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o02,	0,		False),
					"STA":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o03,	0,		False),
					"STB":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o04,	0,		False),
					"AMA":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o05,	0,		False),
					"SMA":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o06,	0,		False),
					"MPY":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o07,	0,		False),
					"DIV":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o10,	0,		False),
					"BRU":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o11,	0,		False),
					"SPB":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o12,	0,		False),
					"IMS":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o14,	0,		False),
					"CMA":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o15,	0,		False),
					"AMB":(SEL810_MREF_OPCODE,		OBJOP_MEMREF_LOAD,	0o16,	0,		False),
					"HLT":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o00,	False),
					"RNA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o01,	False),
					"NEG":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o02,	False),
					"CLA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o03,	False),
					"TBA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o04,	False),
					"TAB":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o05,	False),
					"IAB":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o06,	False),
					"CSB":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o07,	False),
					"RSA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o10,	False),
					"LSA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o11,	False),
					"FRA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o12,	False),
					"FLL":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o13,	False),
					"FRL":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o14,	False),
					"RSL":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o15,	False),
					"LSL":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o16,	False),
					"FLA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o17,	False),
					"ASC":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o20,	False),
					"SAS":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o21,	False),
					"SAZ":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o22,	False),
					"SAN":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o23,	False),
					"SAP":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o24,	False),
					"SOF":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o25,	False),
					"IBS":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o26,	False),
					"ABA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o27,	False),
					"OBA":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o30,	False),
					"LCS":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o31,	False),
					"SNO":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o32,	False),
					"NOP":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o33,	False),
					...
					"STX":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o44,	False),
					"TBP":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o40,	False),
					"TPB":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o41,	False),
					"TBV":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o42,	False),
					"TVB":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o43,	False),
					"LIX":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o45,	False),
					"XPX":(SEL810_AUGMENTED_OPCODE,	OBJOP_DIRECT_LOAD,	0,		0o46,	False),
					...
					"TEU":(SEL810_IO_OPCODE,		OBJOP_DIRECT_LOAD,	0o13,	0o01,	True),
					"SNS":(SEL810_IO_OPCODE,		OBJOP_DIRECT_LOAD,	0o13,	0o04,	False),

					"PID":(SEL810_INT_OPCODES,		OBJOP_DIRECT_LOAD,	0o13,	0o0601,	False), #fixme
					"PIE":(SEL810_INT_OPCODES,		OBJOP_DIRECT_LOAD,	0o13,	0o0600,	False), #fixme

					"AIP":(SEL810_IO_OPCODE,		OBJOP_DIRECT_LOAD,	0o17,	0o01,	False),
					"MOP":(SEL810_IO_OPCODE,		OBJOP_DIRECT_LOAD,	0o17,	0o02,	True),
					"MIP":(SEL810_IO_OPCODE,		OBJOP_DIRECT_LOAD,	0o17,	0o03,	False),
					"AOP":(SEL810_IO_OPCODE,		OBJOP_DIRECT_LOAD,	0o17,	0o00,	False)}
...
#				retbuff.append((int("".join(binary),2)))
	...
	def _get_nmemonic(self,testopcode, testaugmentcode=None):
		for nmemonic,(type,decompose,opcode,augmentcode, second_word) in SEL810_OPCODES.items():
